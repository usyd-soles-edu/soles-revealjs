...
### Fonts
Body text in *Source Sans Pro*, others in *Times New Roman* (official alternate fonts to *Apercu Pro* and *Lyon Display*).

### Colours
Colours are applied in a *neutral* way, using the official University of Sydney colour palette of [**Ochre**]{style="color:#e64626"}, [**Charcoal**]{style="color:#424242"}, [**Heritage Rose**]{style="color:#daa8a2"}, [**Jacaranda**]{style="color:#8f9ec9"} and [**Eucalypt**]{style="color:#71a499"}. No colour is applied to the background, except for code blocks.
...
All written content is in the `template.qmd` file. You may rename it to whatever you like.
